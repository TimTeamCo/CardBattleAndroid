...
namespace MyCompany.Editor
{
    ...
    public class SceneBootstrapper
    {
        ...
        const string k_LoadBootstrapSceneOnPlay = "Card Battle/Load Bootstrap Scene On Play";
        const string k_DoNotLoadBootstrapSceneOnPlay = "Card Battle/Don't Load Bootstrap Scene On Play";
