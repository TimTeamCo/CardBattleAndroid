    ...
    public abstract class AsyncRequest
    {
        public async void DoRequest(Task task, Action onComplete)
        {
            ...
            catch (Exception e)
            {
                ...
                // Note that we log here instead of creating a new Exception in case of a change in calling context during the async call.
                // E.g. Relay has its own exception handling that would intercept this call stack.
